...
function payBet(playerId, money, condition)
    ...
    if condition == "lose" then
        --TriggerClientEvent('QRCore:Notify', src, 8, 'Dealer Won!', 5000, 'Dealer won you lost $'..money, 'mp_lobby_textures', 'cross', 'COLOR_RED')
        TriggerClientEvent('QRCore:Notify', src, 'Dealer won you lost $'..money, "success")
    elseif condition == "win" then
        --TriggerClientEvent('QRCore:Notify', src, 8, 'Blackjack', 5000, 'You Won $'..money2, 'mp_lobby_textures', 'cross', 'COLOR_WHITE')
        TriggerClientEvent('QRCore:Notify', src, 'You Won $'..money2, "success")
        xPlayer.Functions.AddMoney("cash", money2, "Blackjack")
    elseif condition == "push" then
        --TriggerClientEvent('QRCore:Notify', src, 8, 'Blackjack', 5000, "Push! Take your Money Back", 'mp_lobby_textures', 'cross', 'COLOR_WHITE')
        TriggerClientEvent('QRCore:Notify', src, "Push! Take your Money Back", "info")
        xPlayer.Functions.AddMoney("cash", money, "Blackjack")
    end
end
